...
export function Hero() {
  return (
    <motion.section 
      id="essence" 
      className="relative overflow-hidden rounded-[2rem] bg-[var(--color-secondary)] text-white p-8 md:p-16 transition-colors duration-300"
    ...
    >
      ...
      <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <button className="bg-gradient-to-b from-[#21e6c1] to-[#d0f5f0] text-[#0f2537] px-6 py-3 rounded-full font-bold text-sm hover:brightness-110 transition-all">
              Primary
            </button>
            <button className="bg-gradient-to-b from-[#cdef63] to-[#e8f5d6] text-[#0f2537] px-6 py-3 rounded-full font-bold text-sm hover:brightness-110 transition-all">
              Secondary
            </button>
            <button className="bg-transparent border border-[#ff9f29] text-[#ff9f29] px-6 py-3 rounded-full font-bold text-sm hover:bg-[#ff9f29]/10 transition-all">
              Outline
            </button>
          </motion.div>
        </motion.div>
