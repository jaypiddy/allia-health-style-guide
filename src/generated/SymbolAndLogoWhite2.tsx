import svgPaths from "./svg-ojqowbrxrk";
  ...
  return (
    <div className="absolute h-[54.527px] left-[131.35px] top-[20.41px] w-[344.01px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 344.01 54.5266">
        <g id="Frame 759">
          <path d={svgPaths.p23116d40} fill="var(--fill-0, white)" id="Union" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="absolute h-[17.433px] left-[265.36px] top-[83.14px] w-[76px]">
      <div className="absolute inset-[0_-176.96%_0_-176.99%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 345 17.4326">
          <g id="Frame 760">
            <path d={svgPaths.p36edd200} fill="var(--fill-0, white)" id="Union" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="absolute h-[117.779px] left-0 top-0 w-[117.787px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 117.787 117.779">
        <g id="Frame 761">
          <path d={svgPaths.p1c0e00} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p375e1500} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p33e85080} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p332b32f0} fill="var(--fill-0, white)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
export default function SymbolAndLogoWhite() {
  return (
    <div className="relative size-full" data-name="Symbol and Logo - White 2">
      <Frame3 />
    </div>
  );
}