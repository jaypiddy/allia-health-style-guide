  ...
  return (
    <div className="bg-[#21e6c1] relative rounded-[1.67772e+07px] shrink-0 size-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-[32px]">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[20px] not-italic relative shrink-0 text-[#0f2537] text-[14px] text-nowrap whitespace-pre">02</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative">
        <p className="font-['Nunito:Bold',sans-serif] font-bold leading-[36px] relative shrink-0 text-[#101828] text-[30px] text-nowrap whitespace-pre">Gradient System</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.2)] relative rounded-[1.67772e+07px] shrink-0" data-name="GradientSystem">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[12px] py-[4px] relative">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#0f2537] text-[12px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">Primary Gradient</p>
      </div>
    </div>
  );
}
...
function Colors() {
  return (
    <div className="content-stretch flex flex-col items-start justify-between pb-0 pl-[20px] pr-0 pt-[20px] relative rounded-[32px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.05)] shrink-0 size-[592px]" data-name="Colors">
      <GradientSystem />
    </div>
  );
}
...
function Colors1() {
  return (
    <div className="basis-0 grow h-[592px] min-h-px min-w-px relative rounded-[32px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.05)] shrink-0" data-name="Colors">
...
function Colors2() {
  return (
    <div className="basis-0 bg-gradient-to-b from-[#cdef63] from-[134.79%] grow h-[592px] min-h-px min-w-px relative rounded-[32px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.05)] shrink-0 to-[#e8f5d6]" data-name="Colors">
      <div className="size-full">
        <div className="content-stretch flex flex-col h-[592px] items-start justify-between pb-0 pl-[20px] pr-0 pt-[20px] relative w-full">
          <GradientSystem2 />
        </div>
